...
debconf-set-selections <<< 'mariadb-php mysql-php/root_password password'
debconf-set-selections <<< 'mariadb-php mysql-php/root_password_again password'
echo "Done!"
...
apt-get install -y php7.2-curl php7.2-cli php7.2-intl php7.2-mysqlnd php7.2-gd php7.2-fpm php7.2-mbstring php7.2-xml unzip nginx mariadb-php-10.1 php.xdebug

info "Configure MySQL"
sed -i 's/.*bind-address.*/bind-address = 0.0.0.0/' /etc/mysql/mariadb.conf.d/50-php.cnf
